...
public class WeatherListActivity extends AppCompatActivity implements CitiesAdapter.OnItemClick, SwipeRefreshLayout.OnRefreshListener {
    ...
    private List<City> sortAllCities(List<City> loadedCities) {
        Collections.sort(loadedCities, new Comparator<City>() {
            @Override
    ...
    private void showError() {
        mLoadingView.hideLoadingIndicator();
        Snackbar snackbar = Snackbar.make(mRecyclerView, "Error loading weather!!!", Snackbar.LENGTH_SHORT)
